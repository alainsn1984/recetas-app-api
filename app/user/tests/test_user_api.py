...
class PublicUserApiTest(TestCase):
    """Test the public features of the uer API."""
    def setUp(self):
    ...
    def test_create_user_success(self):
        ...
        self.assertNotIn('password', res.data) # Asegurase que la password no viene como respuesta

    def test_user_with_email_exists_error(self):
        """Test error return user email exists."""
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test Name',
...
class PrivateUserAPiTest(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test post is not allowed for rhe me endpoint."""
